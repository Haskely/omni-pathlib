...
from omni_pathlib.providers.s3.type_hints import S3ListObjectsResponse
...
def delete_objects(
    ...
    for error in root.findall(".//Error"):
        error_info = {
            "Key": error.find("Key").text if error.find("Key") is not None else None,
